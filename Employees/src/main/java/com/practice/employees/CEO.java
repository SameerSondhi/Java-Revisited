...
public class CEO extends Employee implements IEmployee, FlyerIF {
    private int avgStockPrice = 0;
    private FlyerIF flyer = new Pilot(1000, true);
    ...
    public CEO(String personText) {
        super(personText);
            Matcher ceoMat = ceoPattern.matcher(mat.group("details"));
            if(ceoMat.find()){
